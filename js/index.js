...
//onteniendo datos del formulario y mostrar

function MostrarDatos(){
    var value_direccion = document.getElementById("form-direccion").value;
    var value_precio = document.getElementById("form-precio").textContent;

    document.getElementById("mostrar_direccion").innerText = 'Entregar pedido en: ' + value_direccion;
    document.getElementById("mostrar_precio").innerHTML = 'Total a pagar es: ' + value_precio;
    
    var id_pedido = Math.round( Math.random()*(100000 - 9999),0);
...
// APARTADO DE SQL GUARDAR EN LA BASE DE DATOS LOS DATOS DEL FORM
...
const mysql = require('mysql');
    ...
    conection.connect(async(err) =>{
        ...
        await console.log('conexión terminó');
    })



    const insertar = "INSERT INTO pedido (id, direccion, precio) VALUES (1234, 'hola', 500)"
